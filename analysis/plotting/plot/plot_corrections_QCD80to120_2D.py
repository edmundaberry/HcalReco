...
for ring in rings:
    ...
    line.Draw("SAME")
    canv.SaveAs("png/delta_uncorrected_QCD80to120_ring_" + ring + ".png")
...
for ring in rings:
    ...
    line.SetLineStyle(r.kDashed)
    line.Draw("SAME")
    canv.SaveAs("png/delta_corrected_QCD80to120_ring_" + ring + ".png")
...
for ring in rings:
    ...
    line.SetLineStyle(r.kDashed)
    line.Draw("SAME")
    canv.SaveAs("png/delta_uncorrected_QCD80to120_over500_ring_" + ring + ".png")
...
for ring in rings:
    ...
    line.SetLineStyle(r.kDashed)
    line.Draw("SAME")
    canv.SaveAs("png/delta_corrected_QCD80to120_over500_ring_" + ring + ".png")
