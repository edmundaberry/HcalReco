...
no_pu_plot = file.Get("no_pu_maxChargeHB")
pu_50_plot = file.Get("pu_50_maxChargeHB")
...
legend.Draw("SAME")
latex.DrawLatex(0.6,0.65,"HB(-8,67,1)")
latex.DrawLatex(0.6,0.60,"Run 1, Event 4463, LS 47")

c.SaveAs("png/pulse_QCD1800MC_PU_vs_NoPU_HB.png")
