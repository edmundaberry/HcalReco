...
// Fri Apr 11 11:00:36 2014 by ROOT version 5.32/00
// from TTree HcalNoiseTree/Hcal noise tree version 1,2134
// found on file: root://eoscms//eos/cms/store/user/eberry/HCALRECO/MinBiasMC/HcalNoise_MinBias_MC_0.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eoscms//eos/cms/store/user/eberry/HCALRECO/MinBiasMC/HcalNoise_MinBias_MC_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eoscms//eos/cms/store/user/eberry/HCALRECO/MinBiasMC/HcalNoise_MinBias_MC_0.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://eoscms//eos/cms/store/user/eberry/HCALRECO/MinBiasMC/HcalNoise_MinBias_MC_0.root:/ExportTree");
